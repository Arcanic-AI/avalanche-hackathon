...
- **AI Sentiment Analysis**: Leverage Cono AI from Arcanic AI to identify mentioned cryptocurrencies and assign a sentiment score (1-10) for each article.
...
- **Crawl Service**: Written in Python, using the FastAPI framework for efficient web scraping of crypto news.
- **Buy/Sell Service**: Built with JavaScript running on Node.js, using the Express.js framework.
- **Login Service**: Written in TypeScript, running on Node.js with the NestJS framework, and uses MySQL for data management.
...
- **Web3.js**: For blockchain integration and smart contract interaction.
...
## Screenshot
![alt text](https://img.upanh.tv/2024/11/19/5zo891X---Imgur.jpg) 
